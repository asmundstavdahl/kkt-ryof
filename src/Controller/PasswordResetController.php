...
use Form\Type\NewPasswordType;
use Form\Type\PasswordResetType;
...
class PasswordResetController extends Controller
{
    ...
    public function showAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            if ($this->createResetPasswordEntity($form, $passwordReset)) {
                return $this->render('reset_password/confirmation.html.twig', array('email' => $form->get('email')->getData()));
            }
        }
    ...
    private function createResetPasswordEntity(Form $form, PasswordReset $passwordReset)
    {
        ...
        $emailMessage = \Swift_Message::newInstance()
            ...
            ->setTo($email)
            ->setBody($this->renderView('reset_password/new_password_email.txt.twig', array('reseturl' => $this->generateUrl('password_new', array('code' => $resetCode), UrlGeneratorInterface::ABSOLUTE_URL))));
    ...
    public function resetPasswordAction($code, Request $request)
    {
        ...
        if ($timeDifference->d < 1) {
            ...
            return $this->render('reset_password/reset_password.html.twig', array('message' => $feedback));
        }
