...
use Form\Type\StaticContentType;
...
class AdminStaticContentController extends Controller
{
    ...
    private function renderForm(Request $request, $idString, $label)
    {
        ...
        $content = $this->getDoctrine()->getRepository('AppBundle:StaticContent')->findOneByStringId($idString, $club);
        if (is_null($content)) {
        ...
        return $this->render('static_content/show_form.html.twig', array(
