...
class UserController extends Controller
{
    ...
    public function registerWithNewUserCodeAction(Request $request)
    {
        ...
        $user = $this->getDoctrine()->getRepository('AppBundle:User')->findOneBy(array('newUserCode' => $hashedCode));
        if (!$user) {
    ...
    public function editUserAction(Request $request)
    {
        ...
        return $this->render('user/update_user_info.html.twig', array(
            'form' => $form->createView(),
        ));
    }
    ...
    public function editPasswordAction(Request $request)
    {
        ...
        return $this->render('user/update_password.html.twig', array(
            'form' => $form->createView(),
        ));
    }
}
