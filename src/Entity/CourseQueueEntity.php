 ...
 * @ORM\Entity(repositoryClass="Repository\CourseQueueEntityRepository")
 */
class CourseQueueEntity
{
     ...
     * @var Course
     *
     * @ORM\ManyToOne(targetEntity="Entity\Course", inversedBy="queue")
     ...
     * @var User
     *
     * @ORM\ManyToOne(targetEntity="\Entity\User", inversedBy="queues")
     ...
     * @var Child
     *
     * @ORM\ManyToOne(targetEntity="\Entity\Child", inversedBy="queues")
