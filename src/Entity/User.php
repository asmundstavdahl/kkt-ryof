...
class User implements UserInterface, EquatableInterface
{
     ...
     * @var Club
     *
     * @ORM\ManyToOne(targetEntity="\Entity\Club")
     * @Assert\Valid
     */
    private $club;
     ...
     * @var Child[]
     *
     * @ORM\OneToMany(targetEntity="Entity\Child", mappedBy="parent", cascade={"remove"})
     */
    private $children;
     ...
     * @var Participant[]
     *
     * @ORM\OneToMany(targetEntity="Entity\Participant", mappedBy="user", cascade={"remove"})
     */
     ...
     * @var Tutor[]
     *
     * @ORM\OneToMany(targetEntity="Entity\Tutor", mappedBy="user", cascade={"remove"})
     */
    private $tutors;
     ...
     *
     * @ORM\OneToMany(targetEntity="Entity\CourseQueueEntity", mappedBy="user", cascade={"remove"})
     */
    private $queues;
